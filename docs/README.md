...
`contested-background.md`, `interception-design.md`, `cells-and-network.md`,
`band-strip.md`, `experiments-design.md`, `architecture-research.md`,
`spectrum-and-sensors-reference.md`, `ros2-and-missions.md`.
